...
unharm_noclip=$(ls -1 *SR_8b.tif                                2>/dev/null | wc -l)
...
echo "UnHarmonized noclip 8b    : $unharm_noclip"
...
accounted=$((harm_clip + clip_mask + unharm_clip + harm_noclip + noclip_mask + unharm_noclip))
